...
async function researchAndRetier(trial) {
    ...
    const result = {
        ...
        email: trial.email,
        original_tier: trial.tier,  // Keep original tier for comparison
        new_tier: null,  // Will assign based on Google Maps data
    ...
    try {
        ...
        const input = {
            ...
            maxCrawledPlaces: 5  // Get a few results to check for multiple locations
        };
        ...
        if (items.length > 0) {
            ...
            // Estimate size from review count
        ...
        result.new_tier = 'Tier 5';  // Error = not a fit
    }
...
async function main() {
    ...
    console.log('RESEARCH & RE-TIER NEXT 50 LEADS');
    console.log('='.repeat(70));
    console.log();

    const inputFile = 'data/output/next_50_restaurant_leads.csv';
    const outputFile = 'data/output/researched_and_retiered_50.csv';
    ...
    console.log();
    console.log('='.repeat(70));
    console.log('RESEARCH & RE-TIERING COMPLETE');
    console.log('='.repeat(70));
